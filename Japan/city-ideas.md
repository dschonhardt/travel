# Japan 2026 — City Ideas / Must-Dos
...
- ☐ teamLab Borderless + the tokyo-style pizza place nearby
- ☐ Meiji Shrine
...
- ☐ Inuyama Castle — ~25–35 min via Meitetsu train from Meitetsu Nagoya Station, ¥630 one-way (Limited Express or Semi-Express, trains every 10–20 min, no reservation needed). Admission ¥1,000/adult (price rising Mar 1, 2026 to fund disaster-prevention renovations), 9:00 AM–5:00 PM (last entry 4:30). One of only 5 National Treasure castles in Japan with an original wooden keep (dates to 1537) — unlike Nagoya Castle's closed concrete rebuild, you actually climb the real, original structure (steep staircases, exposed beams). Castle itself is only 1–2 hrs, but pairs into a half or full day:
  - ☐ Jokamachi castle town — old-street shopping/snack area right around the castle, good for ~1 hr of wandering
  - ☐ Meiji-mura — open-air museum of relocated Meiji-era buildings nearby; the common pairing if turning this into a full day trip
  - ☐ Uraku-en garden — historic teahouse garden near the castle, a shorter add-on alternative to Meiji-mura if aiming for just a half day
...
- ☐ Kanazawa Castle Park — adjacent to Kenrokuen, free to walk grounds
...
Filtered for our route (Tokyo, Nagoya, Takayama, Kanazawa — nothing starred in Shirakawa-go), casual dress (no jacket required), and a ~$250/person ceiling (using a rough ¥150 = $1 exchange rate — recheck closer to the trip). **Open/closed status double-checked Aug 2026.** Dropped: Tsuta and Nakiryu (both Tokyo ramen, removed per request), and Kataori (Kanazawa, ¥60,000–79,000 ≈ $400–530, well over budget).

| Name | City | Stars | Avg Cost (pp) | Notes |
|---|---|---|---|---|
| Katsuzen | Tokyo (Ginza) | ★ | ¥3,800 lunch / ¥8,000+ dinner (~$25 / ~$55+) | Confirmed open. Only Michelin-starred tonkatsu in Tokyo. Family-run, sit-down, no jacket needed but book ahead |
| Sushi Shunbi Nishikawa | Nagoya | ★★ | ¥19,800 lunch, Tue/Thu/Sat/Sun only (~$132) / ¥27,500+ dinner +15% service charge (~$211) | ⚠️ Currently operating from a temporary location inside Espacio Nagoya Castle (through end of Dec 2026, then moving again in 2027) — should still be open for our Oct/Nov 2026 dates, but confirm address when booking. 8-seat counter, Nagoya-mae sushi |
| Ryotei Susaki | Takayama | ★★ | ¥13,000–13,200 for the 11-dish Honzen Kuzushi course (~$87–88) | Confirmed open — operating since 1794, now an Important Cultural Property. This shorter course is what most guests order now instead of the full 30-dish honzen (price for that one not confirmed, could run higher). Kimono-clad service, tatami seating, shoes off — most formal option on this list, not a dress-shirt-casual fit |
| Otome Sushi | Kanazawa | ★★ | ~¥23,000 dinner omakase (~$153), lunch cheaper (12–2pm) | ⚠️ Conflicting status — one listing (Corner, updated Apr 2026) shows it as closed, while other 2026 sources still list active hours/reservations. Couldn't resolve definitively — **call to confirm before counting on this one**. Otherwise near Kenrokuen, sushi counter, casual dress |
| Sushi Kibatani | Kanazawa | ★ | ¥30,000–40,000, dinner only (~$200–267) | Confirmed open — Tabelog Bronze 2020–2026, reviews as recent as July 2026. ⚠️ Upper end of the range is over the $250 line depending on what you order — worth asking about pricing when booking. 8-seat counter near Higashi Chaya |

**Best fit for the budget:** Katsuzen in Tokyo is the clear value pick. Ryotei Susaki (short course) and Otome Sushi are both comfortably under $250 if the availability/status checks out. Sushi Shunbi Nishikawa's lunch seating is the better-value option there over dinner. Sushi Kibatani is the one to watch — it can land right at or past the limit.
