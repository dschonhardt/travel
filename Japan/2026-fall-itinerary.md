...
**Max is leaving early:** departs HND Thu Nov 5, 5:15 PM — separate from the rest of the group's Nov 11 return. Resolved by the Kyoto/Osaka routing above — Max heads back to Tokyo from Kyoto/Osaka (~2h15 Shinkansen) with plenty of margin, rather than trying to make the flight from the Takayama/Kanazawa corridor.
